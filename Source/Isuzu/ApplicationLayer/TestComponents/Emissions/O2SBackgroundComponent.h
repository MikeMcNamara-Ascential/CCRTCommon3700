...
template <class ModuleType> 
class O2SBackgroundComponent : public BackgroundTestComponent
{
public:
    /**
     ...
     */
    O2SBackgroundComponent(IsuzuEmissionsTc<ModuleType> *testComponent);
    /**
     * Class destructor.
     */
    virtual ~O2SBackgroundComponent();
    /**
