...
extern BOOL   pduAddTag(EPATH* pPDU, UINT16 iTagType, UINT16 iTagDataSize, UINT32 lData);
...
extern UINT32 pduGetTagByType( EPATH* pPDU, UINT16 iTagType, INT32 nIndex, UINT16* piTagDataSize );
extern UINT32 pduGetTagByIndex( EPATH* pPDU, UINT16* piTagType, INT32 nIndex, UINT16* piTagDataSize );
