...
{
    public partial class RemoveModelCodeSpecificOptionsForm : Form
    {
        public RemoveModelCodeSpecificOptionsForm(List<String> items)
        {
            InitializeComponent();
        ...
        private void m_itemComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
