...
protected:
    ...
    /**
     * <b>Description:</b>
     * This method is used by the park brake test to do the actual torque 
     * testing with the rollers.  It sends a subtest result. Brake position is checked
     * to ensure operator has no influence
     *
     * <b>Configuration Parameters:</b>
     *     <ul>
     *     <li> ParkBrakeApplyForce </li>
     *     <li> ParkBrakeSpeedValue </li>
     *     </ul>
     * 
     * <b>Test Step Info:</b>
     *     <ul>
     ...
     * <b>Faults:</b>
     *     <ul>
     *     <li> ParkBrakeFault </li>
     *     </ul>
     * 
     * @param direction The direction to turn the rollers.  Valid values are 
     *                  "Forward", "Reverse" or "Both".
     *
     * @return The result for this test step.
     * 
    ...
    virtual const std::string PerformPBTorqueTest(const std::string &direction);
   	/**
	 * Run the electric park brake test.  
	 *
	 * @param value This is the value that was commanded by the test sequencer.
	 * @ return The result of the test.
	 */
   	virtual const std::string TestStepElectricParkBrake(const std::string &value);
private:
