...
// 
//*************************************************************************
#ifndef TrwAbsModule_h
#define TrwAbsModule_h
//-------------------------------------------------------------------------------------------------
#include "GenericABSModuleTemplate.cpp"
//-------------------------------------------------------------------------------------------------
template<class ProtocolFilterType>
class TrwAbsModule : public GenericABSModuleTemplate<ProtocolFilterType>
{
public:
    TrwAbsModule();
    virtual ~TrwAbsModule();

    /**
     * <p><b>Description:</b><br>
     * Return a string representing the name of the module interface.
     * <p>
     * @returns "TRW ABS" for this class
     */
