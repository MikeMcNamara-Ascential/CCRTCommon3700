...
//-------------------------------------------------------------------------------------------------
ToyotaMachineTC::ToyotaMachineTC() : MachineTC()
{   // Nothing special to do here
}

//-------------------------------------------------------------------------------------------------
ToyotaMachineTC::~ToyotaMachineTC()
{   // Nothing special to do here
}
...
//-------------------------------------------------------------------------------------------------
const string ToyotaMachineTC::TestStepReverse(const string &value)
...
//-------------------------------------------------------------------------------------------------
string ToyotaMachineTC::WaitToStart(void)
...
//-------------------------------------------------------------------------------------------------
const string ToyotaMachineTC::TestStepAccelerateToSpeed(const string &value)
