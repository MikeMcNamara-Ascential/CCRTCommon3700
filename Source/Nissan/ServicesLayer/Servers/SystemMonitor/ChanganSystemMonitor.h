...
//===========================================================================
//*************************************************************************
#ifndef ChanganSystemMonitor_h
#define ChanganSystemMonitor_h
//-------------------------------------------------------------------------------------------------
#include "SystemMonitor.h"
//-------------------------------------------------------------------------------------------------
class ChanganSystemMonitor : public SystemMonitor
{
public:
    ChanganSystemMonitor();
    ChanganSystemMonitor(int argc, char *argv[]);
    virtual ~ChanganSystemMonitor();
