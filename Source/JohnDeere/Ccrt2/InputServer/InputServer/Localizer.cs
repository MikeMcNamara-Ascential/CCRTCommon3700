...
namespace InputServer
{
    public class Localizer
    {
        ...
        private void SetupLocalization(String currentLanguage)
        {
            ...
            InputServer.Properties.Settings.Default.CurrentLanguage = currentLanguage;
        ...
        {   // Store the current language
            String orgLanguage = InputServer.Properties.Settings.Default.CurrentLanguage;
            // Display the form for the user
            LocalizationForm form = new LocalizationForm(DisplayCulture, LanguageResMgr);
            form.ShowDialog();
            // Check if the settings have changed
            if (orgLanguage != InputServer.Properties.Settings.Default.CurrentLanguage)
            {
                SetupLocalization(InputServer.Properties.Settings.Default.CurrentLanguage);
            }
        }
