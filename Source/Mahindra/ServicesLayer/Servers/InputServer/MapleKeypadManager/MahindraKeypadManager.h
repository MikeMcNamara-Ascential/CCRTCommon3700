...
protected:
     ...
     */
    //void MahindraKeypadManager::WaitForKeypad(void);
    /**
     ...
     */
    //void MahindraKeypadManager::SetName(const XmlNode *configNode);
    /**
     * Sets the amount of time to wait before attempting a reconnect.
     * 
     * @param delay_ms amount of time to wait in milliseconds
     */ 
    //inline void MahindraKeypadManager::SetReconnectDelay(int delay_ms);
    /**
