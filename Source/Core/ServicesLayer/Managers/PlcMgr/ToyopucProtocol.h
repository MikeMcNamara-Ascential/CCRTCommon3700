...
//
// LOG:
//    $Log: /Ccrt/Source/Core/ServicesLayer/Managers/PlcMgr/ToyopucProtocol.h $
// 
...
#ifndef _TOYO_PROTOCOL_H_INCLUDED_
#define _TOYO_PROTOCOL_H_INCLUDED_
...
// Toyopuc Constants
#define     tRPLC   0x96      // Toyopuc Read Command
...
/**
* Toyopuc protcol wrapper
*
*/
class ToyopucProtocol
{
	//friend class ToyopucProtocolTest; Testing.. PISH TOSH! WHO NEEDS IT?
...
private:
	...
	void LogPlcString( uint32_t logMask, const char *prefix, const uint8_t *plcData, const uint32_t dataLen);
        ...
        void SetPlcCommSetup(const XmlNode *setup);

         /**
	 * Setup node for the serial channel to the Toyopuc PLC system.
	 */
	XmlNode *m_plcCommSetup;
