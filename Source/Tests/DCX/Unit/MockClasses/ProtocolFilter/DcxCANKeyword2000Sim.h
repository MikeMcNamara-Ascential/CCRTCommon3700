//*************************************************************************
// FILE:
//    $Header: /CCRT-cmake/Source/Tests/DCX/Unit/MockClasses/ProtocolFilter/DcxCANKeyword2000Sim.h 1     9/07/07 10:06a Dkrause $
//
// FILE DESCRIPTION:
...
//
// LOG:
//    $Log: /CCRT-cmake/Source/Tests/DCX/Unit/MockClasses/ProtocolFilter/DcxCANKeyword2000Sim.h $
// 
...
// 
//*************************************************************************
#ifndef DcxCANKeyword2000Sim_h
#define DcxCANKeyword2000Sim_h

#include "ProtocolFilter.h"

/**This is a CAN simulartor based off DcxCANKeywork2000ProtocolFilter, its actually simple to use.
 * Insert messages into the replyTable as the will appear after being extracted, then run your code
 * and test that with the correct messages recived, it preforms correctly.
 *
 * replyTable: list of replys you expect to see on the can bus, can simulate what ever you want
 * currentReply: the current reply in the table
 * 
 * after running each unit test it would be advisable to clear the replyTable and reset the currentReply to zero
 *
 * @author Dan Krause
 * @version Version 0.1
 * @see DcxCANKeyword2000ProtocolFilter
 * @since August 23, 2003
 *
 * Current implentation style only works in GetModuleData to inject CAN responses
 */
 ...
 * @since August 23, 2003
 */
class DcxCANKeyword2000Sim : public ProtocolFilter
{
public:
    /**
     * replyTable for holding messages to simulate
     */
    SerialString_t replyTable[100];
    int currentReply;
	/**
	 * Class constructor.
	 *
	 ...
	 * @since Version 1.0
	 */
	DcxCANKeyword2000Sim(KeepAliveTimer_t &lastTxTime, BepMutex *commsInUse = NULL);
	/**
	 * Class destructor.
	 * @since Version 1.0
	 */
	virtual ~DcxCANKeyword2000Sim();
	/**
