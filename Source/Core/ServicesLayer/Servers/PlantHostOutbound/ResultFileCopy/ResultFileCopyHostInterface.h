...
//===========================================================================
#ifndef ResultFileCopyHostInterface_h
#define ResultFileCopyHostInterface_h
//-------------------------------------------------------------------------------------------------
#include "HostInterface.h"

class ResultFileCopyHostInterface : public HostInterface
{
public:

	ResultFileCopyHostInterface();
	virtual  ~ResultFileCopyHostInterface();
...
//-------------------------------------------------------------------------------------------------
#endif //ResultFileCopyHostInterface_h
