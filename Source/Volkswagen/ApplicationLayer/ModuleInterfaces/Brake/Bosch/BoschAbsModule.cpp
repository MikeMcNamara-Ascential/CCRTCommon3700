...
// 
//*************************************************************************
#include "BoschAbsModule.h"

//-------------------------------------------------------------------------------------------------
template<class ProtocolFilter>
BoschAbsModule<ProtocolFilter>::BoschAbsModule() : GenericABSModuleTemplate<ProtocolFilter>()
{   // Nothing special to do here
}

//-------------------------------------------------------------------------------------------------
template<class ProtocolFilter>
BoschAbsModule<ProtocolFilter>::~BoschAbsModule()
{   // Nothing special to here
}

//-------------------------------------------------------------------------------------------------
template<class ProtocolFilter>
inline string BoschAbsModule<ProtocolFilter>::ModuleName()
{
...
//-------------------------------------------------------------------------------------------------
template<class ProtocolFilter>
BEP_STATUS_TYPE BoschAbsModule<ProtocolFilter>::EnterDiagnosticMode()
{
...
//-------------------------------------------------------------------------------------------------
template<class ProtocolFilter>
bool BoschAbsModule<ProtocolFilter>::InitializeHook(const XmlNode *configNode)
...
//-----------------------------------------------------------------------------
template<class ProtocolFilter>
BEP_STATUS_TYPE BoschAbsModule<ProtocolFilter>::ReadFaults(FaultVector_t &faultCodes)
{
    BEP_STATUS_TYPE status = BEP_STATUS_ERROR;
    SerialString_t moduleResponse;
    UINT16 dtcCount;
...
//-----------------------------------------------------------------------------
template<class ProtocolFilter>
inline const UINT8& BoschAbsModule<ProtocolFilter>::DtcCountIndex(const UINT8 *byte /*= NULL*/)
{
...
//-----------------------------------------------------------------------------
template<class ProtocolFilter>
inline const UINT8& BoschAbsModule<ProtocolFilter>::FirstDtcByteIndex(const UINT8 *byte /*= NULL*/)
{
...
//-----------------------------------------------------------------------------
template<class ProtocolFilter>
inline const UINT8& BoschAbsModule<ProtocolFilter>::BytesPerDtc(const UINT8 *byte /*= NULL*/)
{
