...
namespace EcuCommunications
{
    public partial class ECUCommunicationTestForm : Form
    {
        ...
        private CcrtJ2534Defs.ECUMessage CreateECUMessageFromInput()
        {
        ...
        {
            CcrtJ2534Defs.ECUMessage message = CreateECUMessageFromInput();
        ...
        private void MessageThread()
        {
            ...
            CcrtJ2534Defs.ECUMessage message = m_ecuMessage;
            List<byte> data = new List<byte>();
        ...
        {
            m_isISOK = true;
            CcrtJ2534Defs.MessageFilter filter = new CcrtJ2534Defs.MessageFilter();
        ...
        private CcrtJ2534Defs.ECUMessage CreateKwp2000KeepAliveMsg()
        {
            CcrtJ2534Defs.ECUMessage message = new CcrtJ2534Defs.ECUMessage();
            //Add Tx message
            List<byte> txMessage = new List<byte>();
