...
#ifndef ChinaSystemMonitor_h
#define ChinaSystemMonitor_h

/*******************
 Forward Definitions
 ******************/
class ChinaSystemMonitor;
 ...
 */
class ChinaControlData : public ControlData
{
public:
...
public:
     ...
     */
    ChinaSystemMonitor( int argc, char *argv[]);

    /**
     * Class destructor
     */
    virtual ~ChinaSystemMonitor();
