...
#ifndef BASE3700_SYSTEM_MONITOR_INCLUDED
#define BASE3700_SYSTEM_MONITOR_INCLUDED

/*******************
 Forward Definitions
 ******************/
class Base3700SystemMonitor;
 ...
 * @version 1.0
 */
class Base3700SystemMonitor : public SystemMonitor
{
public:
	/**
	 * Default constructor. Set debug to false, channel ID's to -1, etc
	 */
	Base3700SystemMonitor();
	 ...
	 */
	Base3700SystemMonitor( int argc, char *argv[]);

	/**
	 * Class destructor
	 */
	virtual ~Base3700SystemMonitor();
...
#endif	// BASE3700_SYSTEM_MONITOR_INCLUDED
