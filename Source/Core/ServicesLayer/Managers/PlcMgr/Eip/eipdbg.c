...
** EIPDBG.C
**
** COPYRIGHT (c) 2004-2006 Pyramid Solutions, Inc.
**
*****************************************************************************
*****************************************************************************
**
...
void dbgCheckServerSock(void);
void dbgCheckCliSock(void);
void dbgWriteLog(char cType, char *szBuf, int iLen);
void dbgCloseSock(SOCKET *pSock);

UINT8 gSocketTraceFlag;
UINT16 gSocketTraceTypeFlag;
