...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
     ...
     <xsl:template name="BuildData" match="/BepVehicleTestResult/VehicleBuild">
          <h3>
               <u>Chassis End Of Line Testing Report</u>
          </h3>
          <table border="1" rules="all" cellpadding="1">
               ...
               <tr>
                    <td align="left">Chassis #/VIN:</td>
                    <td align="left">
                         <xsl:value-of select="//VIN"/>
                    </td>
                    <td align="left">Chassis Model:</td>
                    <td align="left">
               ...
               <tr>
                    <td align="left">Axle Center to Center:</td>
                    <td align="left">
     ...
     <xsl:template name="TestResults" match="/BepVehicleTestResult/TestResult">
          ...
          <table border="1" rules="all" title="Test Results" cellpadding="1">
               ...
               <!--hr/-->
               <tr bgcolor="white">
                    <th align="center" rowspan="3">1. SIDE SLIP TEST</th>
               </tr>
               <tr>
               ...
               <!--hr/-->
               <tr bgcolor="white">
                    <th align="center" rowspan="3">2. LOCK TO LOCK TEST</th>
               </tr>
               <tr>
               ...
               <!--hr/-->
               <tr bgcolor="white">
                    <th align="center" rowspan="12">3. HEADLIGHT TEST</th>
               </tr>
               <tr>
               ...
               <!--hr/-->
               <tr bgcolor="white">
                    <th align="center" rowspan="8">4. BRAKE TEST</th>
               </tr>
               <tr>
               ...
               <tr>
                    <td align="right">Total Brake Force</td>
                    <td align="center"/>
                    <td align="center">
                         <u>
               ...
               <!--hr/-->
               <tr bgcolor="white">
                    <th align="center" rowspan="4">5. DRAG TEST</th>
               </tr>
               <tr>
                    <td align="right">Left Front</td>
                    <td align="center">
               ...
               <!--hr/-->
               <tr bgcolor="white">
                    <th align="center" rowspan="3">6. PARKING BRAKE</th>
               </tr>
               <tr>
                    <td align="right">Left Front</td>
                    <td align="center">
               ...
               <!--hr/-->
               <tr bgcolor="white">
                    <th align="center" rowspan="6">7. SPEEDOMETER TEST</th>
               </tr>
               <tr>
                    <td align="right" colspan="1">Speed 1</td>
                    <td align="center">
                         <xsl:call-template name="showResult">
               ...
               <tr>
                    <td align="right" colspan="1">Accuracy 1</td>
                    <td align="center">
                         <xsl:call-template name="showResult">
                              <xsl:with-param name="RESULT" select="//SpeedometerSpeedometerTest1/@Result"/>
                         </xsl:call-template>
               ...
               <tr>
                    <td align="right" colspan="1">Speed 2</td>
                    <td align="center">
                         <xsl:call-template name="showResult">
               ...
               <tr>
                    <td align="right" colspan="1">Accuracy 2</td>
                    <td align="center">
                         <xsl:call-template name="showResult">
                              <xsl:with-param name="RESULT" select="//SpeedometerSpeedometerTest2/@Result"/>
                         </xsl:call-template>
               ...
               <!--hr/-->
               <tr bgcolor="white">
                    <th align="center" rowspan="9">8. ACCELERATION TESTS</th>
               </tr>
               <tr>
                    <td align="right" colspan="1">Max Speed 1</td>
                    <td align="center">
                         <xsl:call-template name="showResult">
               ...
               <tr>
                    <td align="right" colspan="1">Time 1</td>
                    <td align="center">
                         <xsl:call-template name="showResult">
                              <xsl:with-param name="RESULT" select="//TransmissionAccelerationTest1/@Result"/>
                         </xsl:call-template>
               ...
               <tr>
                    <td align="right" colspan="1">Max Speed 2</td>
                    <td align="center">
                         <xsl:call-template name="showResult">
               ...
               <tr>
                    <td align="right" colspan="1">Time 2</td>
                    <td align="center">
                         <xsl:call-template name="showResult">
                              <xsl:with-param name="RESULT" select="//TransmissionAccelerationTest2/@Result"/>
                         </xsl:call-template>
               ...
               <tr>
                    <td align="right" colspan="1">Max Speed 3</td>
                    <td align="center">
                         <xsl:call-template name="showResult">
               ...
               <tr>
                    <td align="right" colspan="1">Time 3</td>
                    <td align="center">
                         <xsl:call-template name="showResult">
                              <xsl:with-param name="RESULT" select="//TransmissionAccelerationTest3/@Result"/>
                         </xsl:call-template>
               ...
               <!--hr/-->
               <tr bgcolor="white">
                    <th align="center" rowspan="3">9. HORN TEST</th>
               </tr>
               <tr>
               ...
               <!--hr/-->
               <tr bgcolor="white">
                    <th align="center" rowspan="3">10. OPACITY TEST</th>
               </tr>
               <tr>
               ...
               <!--hr/-->
               <tr bgcolor="white">
                    <th align="center" rowspan="2">11. FINAL TEST RESULT</th>
                    <td align="left">
                         <xsl:call-template name="showResult">
