...
//
// LOG:
//     $Log: /Ccrt/Source/Tests/Core/Unit/ApplicationLayer/TestComponents/Transmission/Common/CommonTransmissionTestRunner.cpp $
// 
...
int main( int argc, char* argv[])
{
    ...
    runner.addTest( new CommonTransmissionTestSuite() );
