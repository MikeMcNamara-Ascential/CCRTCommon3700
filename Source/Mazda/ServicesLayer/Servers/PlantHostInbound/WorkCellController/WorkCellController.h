//*************************************************************************
// FILE:
//    $Header: /HMMA/Source/HMMA/ServicesLayer/Servers/PlantHostInbound/WorkCellController/WorkCellController.h 1     3/09/06 3:16p Gswope $
//
// FILE DESCRIPTION:
...
//
// LOG:
//    $Log: /HMMA/Source/HMMA/ServicesLayer/Servers/PlantHostInbound/WorkCellController/WorkCellController.h $
// 
...
protected:
    ...
    /**
     * Functionality similar to that of SystemRead local to PlantHostInbound
     * 
     * @param tag - the ndb tag to read
     * 
     * @return value - the value read from the ndb tag
     */
    string ReadPlcBit(string tag);
    /**
    ...
    /**
     * Check or set the flag indicating if comms should be established with the static tester server.
     * If the parameter is NULL, the flag will just be returned; otherwise the specified value will be stored.
     *
     * @param  startComms  Flag to indicate if comms with the StaticTesterServer should be started.
     *
     * @return  Flag indicating if comms with the StaticTesterServer should be started.
     */
    const bool& StartStaticTesterServerComms(const bool *startComms = NULL);
    /**
...
private:
    /**
     * Contains a list of body styles and their corresponding drive axle.
     */
    ...
    /**
     * Communication object used to interface withe the static tester server.
     * This object will be used to read any pre-fetched build data from the 
     * static tester server.
     */
    IBepCommunication *m_staticTesterComm;
    /**
    ...
    /**
     * Flag to indicate if static tester comms should be started.
     */
    bool m_startStaticTesterComm;
    /**
     * Class for determining of the vehicle should be tested by NiSP.
     * 
     * @see NispVehicles
     */
    NispVehicles m_nispSupport;
    /**
     * The list that will map PLC bits to the vehicle build info  
     */
    XmlNodeMap m_plcVehicleBuildBits;
};
