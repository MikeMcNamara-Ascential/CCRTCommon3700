...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template name="TestResults" match="/BepVehicleTestResult/TestResult">
        ...
        <table border="1" rules="all" title="Test Results" cellpadding="1">
            ...
            <!-- Reduction Results -->
            <tr>
                <th align="left" width="20">ABS Reduction</th>
                <td align="right">LF</td>
                <td align="center"/>
                <td align="center">
            ...
            <!-- Recovery Results -->
            <tr>
                <th align="left" width="20">ABS Recovery</th>
                <td align="right">LF</td>
                <td align="center">
            ...
            <tr>
                <th align="left" width="20">Steering Wheel</th>
                <td align="center">Angle</td>
                <td align="center">
                    <xsl:value-of select="//MachineReportSteeringWheelAngleValue/SteeringWheelAngleMinValue"/>
                </td>
                <td align="center">
                    <xsl:value-of select="//MachineReportSteeringWheelAngleValue/SteeringWheelAngle"/>
                </td>
                <td align="center">
                    <xsl:value-of select="//MachineReportSteeringWheelAngleValue/SteeringWheelAngleMaxValue"/>
                </td>
                <td align="center">deg</td>
                <td align="center">
                    <xsl:call-template name="showResult">
                        <xsl:with-param name="RESULT" select="//MachineReportSteeringWheelAngleValue/@Result"/>
                    </xsl:call-template>
                </td>
            </tr>
