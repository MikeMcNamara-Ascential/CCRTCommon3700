...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xalan="http://xml.apache.org/xalan">
    ...
    <xsl:template match="/BepVehicleTestResult">
        <xsl:element name="QualityTest">
            ...
            <xsl:element name="DriveCurve">
                <xsl:value-of select="//VehicleBuild/DriveCurve"/>
            </xsl:element>
            <xsl:element name="CycleTime">
                <xsl:value-of select="//VehicleBuild/CycleTime"/>
            </xsl:element>
            <xsl:if test="//TestResult/BrakeDynamicBrakeBurnishCycle">
                <xsl:call-template name="BurnishModule"/>
            </xsl:if>
    ...
    <xsl:template name="BurnishModule" match="//TestResult">
        <xsl:element name="Module">
            <xsl:call-template name="BurnishModuleInfo">
                <xsl:with-param name="NAME">BrakeBurnish</xsl:with-param>
            </xsl:call-template>
            <xsl:call-template name="BrakeBurnishEnergyLF">
                <xsl:with-param name="NAME">BrakeBurnishAmountLF</xsl:with-param>
            </xsl:call-template>
            <xsl:call-template name="BrakeBurnishEnergyRF">
                <xsl:with-param name="NAME">BrakeBurnishAmountRF</xsl:with-param>
            </xsl:call-template>
            <xsl:call-template name="BrakeBurnishEnergyLR">
                <xsl:with-param name="NAME">BrakeBurnishAmountLR</xsl:with-param>
            </xsl:call-template>
            <xsl:call-template name="BrakeBurnishEnergyRR">
                <xsl:with-param name="NAME">BrakeBurnishAmountRR</xsl:with-param>
            </xsl:call-template>
            <xsl:call-template name="BrakeBurnishCycleTime">
                <xsl:with-param name="NAME">BrakeBurnishCycleTime</xsl:with-param>
            </xsl:call-template>
            <xsl:call-template name="BrakeBurnishCount">
                <xsl:with-param name="NAME">BrakeBurnishIterations</xsl:with-param>
            </xsl:call-template>
    ...
    <xsl:template name="BrakeModule" match="//TestResult">
        ...
        <!--xsl:if test="//TestResult/BrakeDynamicBrakeBurnishCycle">
            ...
            <xsl:call-template name="RawTestResult">
                <xsl:with-param name="NAME">RawTestResult</xsl:with-param>
            </xsl:call-template>
...
-->            
    ...
    <xsl:template name="RawTestResult">
        <xsl:param name="NAME"/>
        <xsl:element name="ModuleTest">
            ...
            <xsl:element name="Process">
                <xsl:value-of select="//TestResult/BrakeOverallTest/@Process"/>
            </xsl:element>
            ...
            <xsl:element name="TestResultCode">
                <xsl:value-of select="//TestResult/BrakeOverallTest/@TestResultCode"/>
            </xsl:element>
            ...
            <xsl:element name="TestAttributes">
                <xsl:for-each select="//TestResult/BrakeOverallTest/child::*">
    ...
    <xsl:template name="BurnishModuleInfo">
        <xsl:param name="NAME"/>
        <xsl:element name="ModuleName">
            <xsl:value-of select="$NAME"/>
        </xsl:element>
        <xsl:element name="Result">
            <xsl:value-of select="//TestResult/BrakeDynamicBrakeBurnishCycle/@Result"/>
        </xsl:element>
    </xsl:template>
    ...
    <xsl:template name="BrakeLeftFrontDragTest">
        ...
        <xsl:element name="ModuleTest">
            ...
            <xsl:element name="TestValue">
                ...
                <xsl:attribute name="Min">
                    <xsl:value-of select="//TestResult/BrakeLeftFrontDragTest/MinDragForce"/>
                </xsl:attribute>
    ...
    <xsl:template name="BrakeRightFrontDragTest">
        ...
        <xsl:element name="ModuleTest">
            ...
            <xsl:element name="TestValue">
                ...
                <xsl:attribute name="Min">
                    <xsl:value-of select="//TestResult/BrakeRightFrontDragTest/MinDragForce"/>
                </xsl:attribute>
    ...
    <xsl:template name="BrakeLeftRearDragTest">
        ...
        <xsl:element name="ModuleTest">
            ...
            <xsl:element name="TestValue">
                ...
                <xsl:attribute name="Min">
                    <xsl:value-of select="//TestResult/BrakeLeftRearDragTest/MinDragForce"/>
                </xsl:attribute>
    ...
    <xsl:template name="BrakeRightRearDragTest">
        ...
        <xsl:element name="ModuleTest">
            ...
            <xsl:element name="TestValue">
                ...
                <xsl:attribute name="Min">
                    <xsl:value-of select="//TestResult/BrakeRightRearDragTest/MinDragForce"/>
                </xsl:attribute>
    ...
    <xsl:template name="BrakeBurnish">
        ...
        <xsl:element name="ModuleTest">
            ...
            <xsl:element name="Process">
                <xsl:value-of select="//TestResult/BrakeDynamicBrakeBurnishCycle/@Process"/>
            </xsl:element>
            <xsl:element name="Result">
                <xsl:call-template name="BurnishResult">
                    <xsl:with-param name="RESULT" select="//TestResult/BrakeDynamicBrakeBurnishCycle/@Result"/>
                </xsl:call-template>
            </xsl:element>
            <xsl:element name="ResultDescription">
                <xsl:value-of select="//TestResult/BrakeDynamicBrakeBurnishCycle/@Description"/>
            </xsl:element>
            <xsl:element name="TestResultCode">
                <xsl:value-of select="//TestResult/BrakeDynamicBrakeBurnishCycle/@TestResultCode"/>
            </xsl:element>
            <xsl:element name="TestValue">
                <xsl:attribute name="Units"/>
                <xsl:attribute name="Max"/>
            ...
            <xsl:element name="TestAttributes">
                <xsl:for-each select="//TestResult/BrakeDynamicBrakeBurnishCycle/child::*">
                    <xsl:element name="Attribute">
                        <xsl:element name="AttributeName">
                            <xsl:value-of select="name()"/>
                        </xsl:element>
    ...
    <!-- start new burnish values here -->
    <xsl:template name="BrakeBurnishEnergyLF">
        <xsl:param name="NAME"/>
        <xsl:element name="ModuleTest">
            <xsl:element name="TestName">
                <xsl:value-of select="$NAME"/>
            ...
            <xsl:element name="Process">
                <xsl:value-of select="//TestResult/BrakeLeftFrontBrakeBurnishEnergy/@Process"/>
            </xsl:element>
            <xsl:element name="Result">
                <xsl:call-template name="BurnishResult">
                    <xsl:with-param name="RESULT" select="//TestResult/BrakeLeftFrontBrakeBurnishEnergy/@Result"/>
                </xsl:call-template>
            </xsl:element>
            <xsl:element name="ResultDescription">
                <xsl:value-of select="//TestResult/BrakeLeftFrontBrakeBurnishEnergy/@Description"/>
            </xsl:element>
            <xsl:element name="TestResultCode">
                <xsl:value-of select="//TestResult/BrakeLeftFrontBrakeBurnishEnergy/@TestResultCode"/>
            </xsl:element>
            <xsl:element name="TestValue">
                <xsl:attribute name="Units">
                    <xsl:call-template name="ShowUnits">
                        <xsl:with-param name="UNITS" select="//TestResult/BrakeLeftFrontBrakeBurnishEnergy/LeftFrontBurnishEnergy/@Units"/>
                    </xsl:call-template>
                </xsl:attribute>
                <xsl:attribute name="Max"/>
                <xsl:attribute name="Min">
                    <xsl:value-of select="normalize-space(//TestResult/BrakeLeftFrontBrakeBurnishEnergy/MinLeftFrontBurnishEnergy)"/>
                </xsl:attribute>
                <xsl:value-of select="//TestResult/BrakeLeftFrontBrakeBurnishEnergy/LeftFrontBurnishEnergy"/>
            </xsl:element>
            <xsl:element name="TestAttributes"/>
        </xsl:element>
    </xsl:template>

    <xsl:template name="BrakeBurnishEnergyRF">
        <xsl:param name="NAME"/>
        <xsl:element name="ModuleTest">
            <xsl:element name="TestName">
                <xsl:value-of select="$NAME"/>
            ...
            <xsl:element name="Process">
                <xsl:value-of select="//TestResult/BrakeRightFrontBrakeBurnishEnergy/@Process"/>
            </xsl:element>
            <xsl:element name="Result">
                <xsl:call-template name="BurnishResult">
                    <xsl:with-param name="RESULT" select="//TestResult/BrakeRightFrontBrakeBurnishEnergy/@Result"/>
                </xsl:call-template>
            </xsl:element>
            <xsl:element name="ResultDescription">
                <xsl:value-of select="//TestResult/BrakeRightFrontBrakeBurnishEnergy/@Description"/>
            </xsl:element>
            <xsl:element name="TestResultCode">
                <xsl:value-of select="//TestResult/BrakeRightFrontBrakeBurnishEnergy/@TestResultCode"/>
            </xsl:element>
            <xsl:element name="TestValue">
                <xsl:attribute name="Units">
                    <xsl:call-template name="ShowUnits">
                        <xsl:with-param name="UNITS" select="//TestResult/BrakeRightFrontBrakeBurnishEnergy/RightFrontBurnishEnergy/@Units"/>
                    </xsl:call-template>
                </xsl:attribute>
                <xsl:attribute name="Max"/>
                <xsl:attribute name="Min">
                    <xsl:value-of select="normalize-space(//TestResult/BrakeRightFrontBrakeBurnishEnergy/MinRightFrontBurnishEnergy)"/>
                </xsl:attribute>
                <xsl:value-of select="//TestResult/BrakeRightFrontBrakeBurnishEnergy/RightFrontBurnishEnergy"/>
            </xsl:element>
            <xsl:element name="TestAttributes"/>
        </xsl:element>
    </xsl:template>

    <xsl:template name="BrakeBurnishEnergyLR">
        <xsl:param name="NAME"/>
        <xsl:element name="ModuleTest">
            <xsl:element name="TestName">
                <xsl:value-of select="$NAME"/>
            ...
            <xsl:element name="Process">
                <xsl:value-of select="//TestResult/BrakeLeftRearBrakeBurnishEnergy/@Process"/>
            </xsl:element>
            <xsl:element name="Result">
                <xsl:call-template name="BurnishResult">
                    <xsl:with-param name="RESULT" select="//TestResult/BrakeLeftRearBrakeBurnishEnergy/@Result"/>
                </xsl:call-template>
            </xsl:element>
            <xsl:element name="ResultDescription">
                <xsl:value-of select="//TestResult/BrakeLeftRearBrakeBurnishEnergy/@Description"/>
            </xsl:element>
            <xsl:element name="TestResultCode">
                <xsl:value-of select="//TestResult/BrakeLeftRearBrakeBurnishEnergy/@TestResultCode"/>
            </xsl:element>
            <xsl:element name="TestValue">
                <xsl:attribute name="Units">
                    <xsl:call-template name="ShowUnits">
                        <xsl:with-param name="UNITS" select="//TestResult/BrakeLeftRearBrakeBurnishEnergy/LeftRearBurnishEnergy/@Units"/>
                    </xsl:call-template>
                </xsl:attribute>
                <xsl:attribute name="Max"/>
                <xsl:attribute name="Min">
                    <xsl:value-of select="normalize-space(//TestResult/BrakeLeftRearBrakeBurnishEnergy/MinLeftRearBurnishEnergy)"/>
                </xsl:attribute>
                <xsl:value-of select="//TestResult/BrakeLeftRearBrakeBurnishEnergy/LeftRearBurnishEnergy"/>
            </xsl:element>
            <xsl:element name="TestAttributes"/>
        </xsl:element>
    </xsl:template>

    <xsl:template name="BrakeBurnishEnergyRR">
        <xsl:param name="NAME"/>
        <xsl:element name="ModuleTest">
            <xsl:element name="TestName">
                <xsl:value-of select="$NAME"/>
            ...
            <xsl:element name="Process">
                <xsl:value-of select="//TestResult/BrakeRightRearBrakeBurnishEnergy/@Process"/>
            </xsl:element>
            <xsl:element name="Result">
                <xsl:call-template name="BurnishResult">
                    <xsl:with-param name="RESULT" select="//TestResult/BrakeRightRearBrakeBurnishEnergy/@Result"/>
                </xsl:call-template>
            </xsl:element>
            <xsl:element name="ResultDescription">
                <xsl:value-of select="//TestResult/BrakeRightRearBrakeBurnishEnergy/@Description"/>
            </xsl:element>
            <xsl:element name="TestResultCode">
                <xsl:value-of select="//TestResult/BrakeRightRearBrakeBurnishEnergy/@TestResultCode"/>
            </xsl:element>
            <xsl:element name="TestValue">
                <xsl:attribute name="Units">
                    <xsl:call-template name="ShowUnits">
                        <xsl:with-param name="UNITS" select="//TestResult/BrakeRightRearBrakeBurnishEnergy/RightRearBurnishEnergy/@Units"/>
                    </xsl:call-template>
                </xsl:attribute>
                <xsl:attribute name="Max"/>
                <xsl:attribute name="Min">
                    <xsl:value-of select="normalize-space(//TestResult/BrakeRightRearBrakeBurnishEnergy/MinRightRearBurnishEnergy)"/>
                </xsl:attribute>
                <xsl:value-of select="//TestResult/BrakeRightRearBrakeBurnishEnergy/RightRearBurnishEnergy"/>
            </xsl:element>
            <xsl:element name="TestAttributes"/>
        </xsl:element>
    </xsl:template>

    <xsl:template name="BrakeBurnishCount">
        <xsl:param name="NAME"/>
        <xsl:element name="ModuleTest">
            <xsl:element name="TestName">
                <xsl:value-of select="$NAME"/>
            ...
            <xsl:element name="Process">
                <xsl:value-of select="//TestResult/BrakeDynamicBrakeBurnishIterations/@Process"/>
            </xsl:element>
            <xsl:element name="Result">
                <xsl:call-template name="BurnishResult">
                    <xsl:with-param name="RESULT" select="//TestResult/BrakeDynamicBrakeBurnishIterations/@Result"/>
                </xsl:call-template>
            </xsl:element>
            <xsl:element name="ResultDescription">
                <xsl:value-of select="//TestResult/BrakeDynamicBrakeBurnishIterations/@Description"/>
            </xsl:element>
            <xsl:element name="TestResultCode">
                <xsl:value-of select="//TestResult/BrakeDynamicBrakeBurnishIterations/@TestResultCode"/>
            </xsl:element>
            <xsl:element name="TestValue">
                <xsl:attribute name="Units">
                    <xsl:call-template name="ShowUnits">
                        <xsl:with-param name="UNITS" select="//TestResult/BrakeDynamicBrakeBurnishIterations/BurnishIterations/@Units"/>
                    </xsl:call-template>
                </xsl:attribute>
                <xsl:attribute name="Max">
                    <xsl:value-of select="normalize-space(//TestResult/BrakeDynamicBrakeBurnishIterations/MaxBurnishIterations)"/>
                </xsl:attribute>
                <xsl:attribute name="Min">
                    <xsl:value-of select="normalize-space(//TestResult/BrakeDynamicBrakeBurnishIterations/MinBurnishIterations)"/>
                </xsl:attribute>
                <xsl:value-of select="//TestResult/BrakeDynamicBrakeBurnishIterations/BurnishIterations"/>
            </xsl:element>
            <xsl:element name="TestAttributes"/>
        </xsl:element>
    </xsl:template>

    <xsl:template name="BrakeBurnishCycleTime">
        <xsl:param name="NAME"/>
        <xsl:element name="ModuleTest">
            <xsl:element name="TestName">
                <xsl:value-of select="$NAME"/>
            ...
            <xsl:element name="Process">
                <xsl:value-of select="//TestResult/BrakeDynamicBrakeBurnishCycleTime/@Process"/>
            </xsl:element>
            <xsl:element name="Result">
                <xsl:call-template name="BurnishResult">
                    <xsl:with-param name="RESULT" select="//TestResult/BrakeDynamicBrakeBurnishCycleTime/@Result"/>
                </xsl:call-template>
            </xsl:element>
            <xsl:element name="ResultDescription">
                <xsl:value-of select="//TestResult/BrakeDynamicBrakeBurnishCycleTime/@Description"/>
            </xsl:element>
            <xsl:element name="TestResultCode">
                <xsl:value-of select="//TestResult/BrakeDynamicBrakeBurnishCycleTime/@TestResultCode"/>
            </xsl:element>
            <xsl:element name="TestValue">
                <xsl:attribute name="Units">
                    <xsl:call-template name="ShowUnits">
                        <xsl:with-param name="UNITS" select="//TestResult/BrakeDynamicBrakeBurnishCycleTime/BurnishCycleTime/@Units"/>
                    </xsl:call-template>
                </xsl:attribute>
                <xsl:attribute name="Max"/>
                <xsl:attribute name="Min"/>
                <xsl:value-of select="//TestResult/BrakeDynamicBrakeBurnishCycleTime/BurnishCycleTime"/>
            </xsl:element>
            <xsl:element name="TestAttributes"/>
        </xsl:element>
    </xsl:template>
    <!-- end new burnish values -->
    <!--
            ...
            <xsl:otherwise>
                <xsl:choose>
                    <xsl:when test="$VALUE = '508202'">
                        <xsl:element name="Machine">
                            <xsl:text>LANE2</xsl:text>
                        </xsl:element>
                    </xsl:when>
                    <xsl:otherwise>
                                <xsl:element name="Machine">
                                    <xsl:text>LANE3</xsl:text>
                                </xsl:element>
                    </xsl:otherwise>
                </xsl:choose>
            </xsl:otherwise>
