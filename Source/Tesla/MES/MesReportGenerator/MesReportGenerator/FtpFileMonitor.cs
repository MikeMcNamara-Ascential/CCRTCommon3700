...
namespace FtpFileMonitorNamespace
{
    public class FtpFileMonitor
    {
        ...
        protected CcrtReportGenerator m_logger;
        ...
        public FtpFileMonitor(string remoteLocation, string localLocation, string tempLocalLocation, int fileCheckInterval,
            string userLogin, string password, string ftpServerIp, string fileMask = "*", CcrtReportGenerator logger = null)
        {
        ...
        public FtpFileMonitor(List<string> remoteLocations, string localLocation, List<string> userLogins,
            List<string> passwords, List<string> ftpServerIps, string fileMask = "*", CcrtReportGenerator logger = null)
        {
            DirectoryLock = new object();
        ...
        {
            //change ToString display the messgae?
            LogString += System.Environment.NewLine + message;
            //m_logger.DisplayStatusMessage(message);
        ...
        public virtual string GetLog()
        {
            ...
            string tempString = "" + LogString;
            LogString = "";
            return tempString;

        }

        public virtual int GetLogLength()
        {
