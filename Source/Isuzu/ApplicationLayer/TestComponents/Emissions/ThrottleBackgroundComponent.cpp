...
//
//*************************************************************************
#include "ThrottleBackgroundComponent.h"

template <class ModuleType>
ThrottleBackgroundComponent<ModuleType>::ThrottleBackgroundComponent(IsuzuEmissionsTc<ModuleType> *testComponent) :
...
template<class ModuleType>
ThrottleBackgroundComponent<ModuleType>::~ThrottleBackgroundComponent()
{   // Nothing special to do here
}
	
template<class ModuleType>
BEP_STATUS_TYPE ThrottleBackgroundComponent<ModuleType>::RunBackgroundComponent()
{
...
template<class ModuleType>
INT32 ThrottleBackgroundComponent<ModuleType>::WaitUntilDone(void)
{
