//*************************************************************************
// FILE DESCRIPTION:
//  Module Interface for the Teves MK60 ABS.
//
//===========================================================================
...
// 
//*************************************************************************
#include "TevesMk60Module.h"

//-------------------------------------------------------------------------------------------------
template<class ProtocolFilterType>
TevesMk60Module<ProtocolFilterType>::TevesMk60Module() : GenericABSModuleTemplate<ProtocolFilterType>()
{   // Nothing special to do here
}

//-------------------------------------------------------------------------------------------------
template<class ProtocolFilterType>
TevesMk60Module<ProtocolFilterType>::~TevesMk60Module()
{   // Nothing special to do here
}

//-------------------------------------------------------------------------------------------------
template<class ProtocolFilterType>
inline string TevesMk60Module<ProtocolFilterType>::ModuleName(void)
{
    return "Teves MK60 ABS";
}

//-------------------------------------------------------------------------------------------------
template<class ProtocolFilterType>
BEP_STATUS_TYPE TevesMk60Module<ProtocolFilterType>::EnterDiagnosticMode(void)
{
...
bool TevesMk60Module<ProtocolFilter>::InitializeHook(const XmlNode *configNode)
...
//-----------------------------------------------------------------------------
template<class ProtocolFilter>
BEP_STATUS_TYPE TevesMk60Module<ProtocolFilter>::ReadFaults(FaultVector_t &faultCodes)
{
    BEP_STATUS_TYPE status = BEP_STATUS_ERROR;
    SerialString_t moduleResponse;
    UINT16 dtcCount;
...
//-----------------------------------------------------------------------------
template<class ProtocolFilter>
inline const UINT8& TevesMk60Module<ProtocolFilter>::DtcCountIndex(const UINT8 *byte /*= NULL*/)
{
...
//-----------------------------------------------------------------------------
template<class ProtocolFilter>
inline const UINT8& TevesMk60Module<ProtocolFilter>::FirstDtcByteIndex(const UINT8 *byte /*= NULL*/)
{
...
//-----------------------------------------------------------------------------
template<class ProtocolFilter>
inline const UINT8& TevesMk60Module<ProtocolFilter>::BytesPerDtc(const UINT8 *byte /*= NULL*/)
{
