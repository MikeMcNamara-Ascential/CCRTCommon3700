//*************************************************************************
// FILE DESCRIPTION:
//	Module Interface for the Aisin Transmission controller.
//
//===========================================================================
...
// 
//*************************************************************************
#ifndef AisinTransmissionModule_h
#define AisinTransmissionModule_h
#define DTC_MESSAGE_SIZE 8
//*************************************************************************
#include "GenericTransmissionModuleTemplate.cpp"

/**
 * Aisin Transmission control module interface.
 * This class handles all the Aisin module specific functions.
 */
template <class ProtocolFilterType> 
class AisinTransmissionModule : public GenericTransmissionModuleTemplate<ProtocolFilterType>
{
public:
	/**
	 * Class constructor.  
	 */
	AisinTransmissionModule(void);
	 ...
	 * here.
	 */
	virtual ~AisinTransmissionModule(void);
    ...
    /**
     * Monitor fault status in the module.
     * 
     * @param filter Protocol filter object to use for reading faults from the module.
     * 
     * @return Status of monitoring faults from the module.
     */
...
//*************************************************************************
#endif  //AisinTransmissionModule_h
