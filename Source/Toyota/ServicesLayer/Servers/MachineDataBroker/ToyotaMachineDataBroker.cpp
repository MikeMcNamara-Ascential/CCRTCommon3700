...
//-------------------------------------------------------------------------------------------------
ToyotaMachineDataBroker::ToyotaMachineDataBroker() : MachineDataBroker(), m_ndb(NULL)
{   // Nothing special to do here
}

//-------------------------------------------------------------------------------------------------
ToyotaMachineDataBroker::~ToyotaMachineDataBroker()
...
//-------------------------------------------------------------------------------------------------
void ToyotaMachineDataBroker::Initialize(const XmlNode *document)
{   // Call the base class to begin the initialization sequence
    ...
    Log(LOG_FN_ENTRY, "ToyotaMachineDataBroker::Initialize() - Enter");
    ...
    Log(LOG_FN_ENTRY, "ToyotaMachineDataBroker::Initialize() - Exit");
}

//-------------------------------------------------------------------------------------------------
const string ToyotaMachineDataBroker::Register(void)
...
//-------------------------------------------------------------------------------------------------
const INT32 ToyotaMachineDataBroker::HandlePulse(const INT32 code, const INT32 value)
{
...
//-------------------------------------------------------------------------------------------------
INT32 ToyotaMachineDataBroker::IcmDataPulseHandler(void)
...
//-------------------------------------------------------------------------------------------------
const string ToyotaMachineDataBroker::Publish(const XmlNode *node)
...
//-------------------------------------------------------------------------------------------------
const INT32 ToyotaMachineDataBroker::ProcessLoadCellReadings(void)
{
...
//-------------------------------------------------------------------------------------------------
void ToyotaMachineDataBroker::SetupLoadCellTimer(const XmlNode *config)
{
    UINT64 dataDelay = 0;
    try
    {
...
//-------------------------------------------------------------------------------------------------
void ToyotaMachineDataBroker::StoreLoadCellConversionFactors(const XmlNode *factors)
{
...
//-------------------------------------------------------------------------------------------------
void ToyotaMachineDataBroker::StoreDistanceParameters(const XmlNode *params)
{   // Set the pulse count
    UINT16 pulseCount = 0;
    try
    {
...
//-------------------------------------------------------------------------------------------------
inline const UINT16& ToyotaMachineDataBroker::EncoderPulseCount(const UINT16 *pulseCount /*= NULL*/)
{
...
//-------------------------------------------------------------------------------------------------
inline const float ToyotaMachineDataBroker::RollerDiameter(const float *diameter /*= NULL*/)
{
