...
namespace VehicleCommServer
{
    public interface IVehicleCommServerInterface
    {
        ...
        CcrtJ2534Defs.ECUMessage message, ref List<byte> data);
        bool GetECUData(string deviceName, string commChannelName, 
        CcrtJ2534Defs.ECUMessage message, ref List<byte> data);
        bool GetECUData(string deviceName, string commChannelName,
        CcrtJ2534Defs.ECUMessage message, ref List<List<byte>> data, bool globalRequest);
        ...
        CcrtJ2534Defs.ECUMessage message, ref int msgID);
