...
** project for either static or dynamic linking to the Master Library DLL.
**
*****************************************************************************
*****************************************************************************
**
...
#ifndef ET_IP_ADAPTER_H
#define ET_IP_ADAPTER_H
...
#ifndef ET_IP_API
#define ET_IP_API		extern "C" __declspec(dllimport)
#endif
...
** piAssemblyInstanceArray should point to the array of MAX_ASSEMBLIES integers.
...
**---------------------------------------------------------------------------
*/
ET_IP_API int ET_IP_CALLBACK EtIPSetAssemblyMemberData( int iAssemblyInstance, int nMember, unsigned char* pData, int nSize );
...
**
** Send either UCMM or Unconnected Send depending on whether pRequest->networkPath
