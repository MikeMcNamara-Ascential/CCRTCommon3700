...
int main(int argc, char *argv[])
{
	...
	try
	{
		...
		if(commBus == "CAN")
		{
			speedControlTest = new SgmwCruiseTc<GenericEmissionsModuleTemplate<KwpCanProtocolFilter> >;
		}
		else
		{
			speedControlTest = new SgmwCruiseTc<GenericEmissionsModuleTemplate<KeywordProtocolFilter> >;
		}
