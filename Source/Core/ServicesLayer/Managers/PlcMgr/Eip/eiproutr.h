...
#define ROUTER_OBJECT_COUNT                    8+SCANNER_OBJECT_COUNT+QOS_OBJECT_COUNT
...
#define ROUTER_ATTR_OPTIONAL_COUNT			2	/* Number of optional attributes implemented as defined by the CIP spec */
