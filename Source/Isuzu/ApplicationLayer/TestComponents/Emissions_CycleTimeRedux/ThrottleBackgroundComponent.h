...
// Forward declaration of the IsuzuEmissionsTc class for the compiler
template <class ModuleType>
class IsuzuEmissionsTc;

template <class ModuleType> 
class ThrottleBackgroundComponent : public BackgroundTestComponent
{
public:
    /**
     ...
     */
    ThrottleBackgroundComponent(IsuzuEmissionsTc<ModuleType> *testComponent);
    /**
     * Class destructor.
     */
    virtual ~ThrottleBackgroundComponent();
    /**
...
protected:
     ...
     */
    IsuzuEmissionsTc<ModuleType> *m_testComponent;
};
