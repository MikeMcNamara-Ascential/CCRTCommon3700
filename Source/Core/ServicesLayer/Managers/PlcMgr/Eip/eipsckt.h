...
#ifndef PYRAMID_SOLUTIONS_SOCKET_H
#define PYRAMID_SOLUTIONS_SOCKET_H
...
#define INVALID_IP_ADDRESS                0        /* Invalid IP address */
#define INVALID_IP_ADDRESS_INDEX          (-1)     /* Invalid IP address arrays index */
...
#endif  /* PYRAMID_SOLUTIONS_SOCKET_H */
