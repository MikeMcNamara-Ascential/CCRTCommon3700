...
//
// LOG:
//    $Log: /CCRT-cmake/Source/Tests/DCX/Unit/ApplicationLayer/ModuleInterfaces/DCXModuleInterfacesTestRunner.cpp $
// 
...
int main( int argc, char* argv[])
{
    ...
    // Make the test
    runner.addTest( new DCXModuleInterfacesTestSuite() );
