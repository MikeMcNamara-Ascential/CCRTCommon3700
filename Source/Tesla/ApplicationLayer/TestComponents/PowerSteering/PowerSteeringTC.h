...
// $NoKeywords: $
//==============================================================================
#ifndef PowerSteeringTC_h
#define PowerSteeringTC_h
//-----------------------------------------------------------------------------
#include "GenericTCTemplate.cpp"
//-----------------------------------------------------------------------------
template<class ModuleType>
class PowerSteeringTC : public GenericTCTemplate<ModuleType> {
public:
    /** Class constructor */
    PowerSteeringTC();
    /** Class destructor */
    virtual ~PowerSteeringTC();
    /**
