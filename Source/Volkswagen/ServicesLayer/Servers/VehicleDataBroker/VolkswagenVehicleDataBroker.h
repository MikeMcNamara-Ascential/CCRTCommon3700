...
//===========================================================================
#ifndef VolkswagenVehicleDataBroker_h
#define VolkswagenVehicleDataBroker_h
//-------------------------------------------------------------------------------------------------
#include "VehicleDataBroker.h"
//-------------------------------------------------------------------------------------------------
class VolkswagenVehicleDataBroker : public VehicleDataBroker
{
public:
    VolkswagenVehicleDataBroker();
    virtual ~VolkswagenVehicleDataBroker();
    /**
...
//-------------------------------------------------------------------------------------------------
#endif //VolkswagenVehicleDataBroker_h
