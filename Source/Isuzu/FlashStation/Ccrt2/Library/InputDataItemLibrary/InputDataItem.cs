...
namespace InputDataItemLibrary
{
    public class InputDataItem
    {
        ...
        /// <param name="headerData">Header data received as part of the data string.</param>
        /// <param name="headerDataLength">Length of the header data.</param>
        /// <param name="trailerData">Trailer data received as part of the data string.</param>
        /// <param name="trailerDataLength">Length of the trailer data.</param>
        public void UpdatedataItemSettings(String dataName, Int32 minLength, Int32 maxLength,
                                           String headerData, Int32 headerDataLength,
                                           String trailerData, Int32 trailerDataLength)
        {
            ItemSettings.DataName = dataName;
            ItemSettings.MinDataLength = minLength;
            ItemSettings.MaxDataLength = maxLength;
            ItemSettings.HeaderData = headerData;
            ItemSettings.HeaderDataLength = headerDataLength;
            ItemSettings.TrailerData = trailerData;
            ItemSettings.TrailerDataLength = trailerDataLength;
        }
        ...
        public Boolean ValidateInputData(byte[] inputData, Int32 byteCount)
        {
            ...
            {   // Length is good, check the header data
                Boolean headerGood = DataMatches(inputData, ItemSettings.HeaderData, 0, 
                                                 ItemSettings.HeaderDataLength);
                // Check trailer data
                Boolean trailerGood = DataMatches(inputData, ItemSettings.TrailerData, 
                                                  byteCount - ItemSettings.TrailerDataLength,
                                                  ItemSettings.TrailerDataLength);
                validData = (headerGood && trailerGood);
            }
        ...
        public Boolean ValidateInputData(char[] inputData, Int32 byteCount)
        {
            ...
            if ((ValidMinDataLength <= byteCount) && (byteCount <= ValidMaxDataLength))
            {   // Length is good, check the header and trailer
                Boolean headerGood = DataMatches(inputData, ItemSettings.HeaderData, 0,
                                                 ItemSettings.HeaderDataLength);
                Boolean trailerGood = DataMatches(inputData, ItemSettings.TrailerData,
                                                  byteCount - ItemSettings.TrailerDataLength,
        ...
        {
            get { return ItemSettings.HeaderDataLength + ItemSettings.TrailerDataLength + ItemSettings.MinDataLength; }
        }
        ...
        {
            get { return ItemSettings.HeaderDataLength + ItemSettings.TrailerDataLength + ItemSettings.MaxDataLength; }
        }
