...
// $NoKeywords: $
//==============================================================================
#ifndef GMClassIIProtocolFilter_h
#define GMClassIIProtocolFilter_h
//==============================================================================

#include "ProtocolFilter.h"

/**
 * GMClassII Protocol filter.
 * This class will send and receive GMClassII messages.
 * The ExtractModuleData() method has been instantiated to strip the header and
 * checksum from the module response.
 *
 */
class GMClassIIProtocolFilter : public ProtocolFilter
{
public:
    /**
     * Class Constructor
     ...
     * @since Version 1.0
     */
    GMClassIIProtocolFilter(KeepAliveTimer_t &lastTxTime, StopCommsBepCondVar *stopCommsBepCondVar = NULL, BepMutex *commsInUse = NULL);

    /**
     * Class destructor.
     * @since Version 1.0
     */
    virtual ~GMClassIIProtocolFilter();
    /**
    ...
    const SerialString_t GetTesterRequestID(void);
    const SerialString_t GetJ1850PriorityCode(void);
    /**
...
private:    
    ...
    void SetJ1850PriorityCode(const UINT8& priorityCode);

    void SetTesterRequestID(const UINT8& testerID);
    ...
    UINT8 m_j1850PriorityCode;
    UINT8 m_testerRequestID;
    UINT32 m_dataByteCountIndex;
};

#endif //GMClassIIProtocolFilter_h
