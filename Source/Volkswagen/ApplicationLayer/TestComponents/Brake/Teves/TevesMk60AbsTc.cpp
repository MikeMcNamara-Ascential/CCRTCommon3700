...
// 
//*************************************************************************
#include "TevesMk60AbsTc.h"

//-------------------------------------------------------------------------------------------------
template<class ModuleType>
TevesMk60AbsTc<ModuleType>::TevesMk60AbsTc() : GenericABSTCTemplate<ModuleType>()
{   // Nothing special to do here
}

//-------------------------------------------------------------------------------------------------
template<class ModuleType>
TevesMk60AbsTc<ModuleType>::~TevesMk60AbsTc()
{   // Nothing special to do here
}

//-------------------------------------------------------------------------------------------------
template<class ModuleType>
void TevesMk60AbsTc<ModuleType>::InitializeHook(const XmlNode *config)
...
//-------------------------------------------------------------------------------------------------
template<class ModuleType>
string TevesMk60AbsTc<ModuleType>::SensorTest(void)
{   // Log the entry and determine if this test should be performed
    Log(LOG_FN_ENTRY, "TevesMk60AbsTc::SensorTest() - Enter");
    ...
    Log(LOG_FN_ENTRY, "TevesMk60AbsTc::SensorTest() - Exit");
    return testResult;
}

//-------------------------------------------------------------------------------------------------
template<class ModuleType>
string TevesMk60AbsTc<ModuleType>::RotateRoller(const UINT8 &rollerIndex, 
