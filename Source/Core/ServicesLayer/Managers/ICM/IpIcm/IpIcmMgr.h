...
//
// LOG:
//    $Log: /Ccrt/Source/Core/ServicesLayer/Managers/ICM/IpIcm/IpIcmMgr.h $
// 
// 6     7/19/06 6:10p Cward
// Added support for Tandem Wheel Speeds
//
// 5     6/21/06 4:39p Cward
// Added ability to reload config file without rebooting
//
// 1     6/07/06 3:27p Rwiersem
// Made the test class a friend.
//
// 4     7/20/05 9:13p Cward
// Added support for commandable overspeed
//
// 2     5/25/05 10:21a Bmeinke
// Added Overspeed parameter to config file (Setup/Overspeed)
// Added commandable Overspeed value via system Write(Overspeed, value)
//
...
// Initial checkin
//
// 2     6/26/03 1:41p Khykin
// Updated with Brians latest changes.
//
// 3     6/23/03 10:13a Bmeinke
...
//
// 6     4/30/03 2:53p Bmeinke
// Made new IcmTimer class (used for data sampling if not using
// interrupts)
// IsrWatchdogTimer is now a derived calss from IcmTimer
...
//
// 4     3/12/03 9:25p Bmeinke
// Added IsrWatchdogTimer class to help detect when the ICM is not
// generating interrupts to us.
// Added DetachIsr() method
//
// 3     3/12/03 7:38p Bmeinke
// Moved IcmSubChannelIdx_t back to this file because of differences with
// the original VME ICM sub channel indices
// Added IcmBlockIdx_t data type to enumerate the index values for block
// data
//
...
#include "Pci40.h"				// SBS PCI40 IP Carrier Object
...
typedef vector< Pci40*>                     Pci40List_t;
typedef Pci40List_t::iterator               Pci40ListItr_t;
typedef Pci40List_t::const_iterator         Pci40ListCItr_t;
