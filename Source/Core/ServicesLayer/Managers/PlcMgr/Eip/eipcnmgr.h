...
extern void connmgrInitBufFromFwdOpenReply( UINT8* buf, FWD_OPEN_REPLY* fwdOpenTypeReply );
...
extern void connmgrInitBufFromFwdCloseReply( UINT8* buf, FWD_CLOSE_REPLY* fwdCloseTypeReply );

extern void connmgrPrepareConnection(SESSION* pSession, CONNECTION* pConnection, REQUEST* pRequest, UINT8 bAppSize, UINT8* pAppData);
extern void connmgrPrepareFwdOpenReply( SESSION* pSession, CONNECTION* pConnection, REQUEST* pRequest, UINT8 bAppSize, UINT8* pAppData);
