...
#define SESSION_INACTIVITY_TIMEOUT			60000			/* Amount of time without any session activity before it is closed */
...
typedef enum tagOpenSessionState
{
    ...
    OpenSessionWaitingForRegisterResponse         = 0x4,    /* Waiting for the response for the Resister Session sent */
    OpenSessionWaitingForRegister                 = 0x5,    /* Waiting for the Resister Session on the incoming session */
    OpenSessionEstablished                        = 0x6    /* Session is opened     */
}
OpenSessionState;
...
extern void  sessionInitialize( SESSION* pSession );
...
extern INT32 sessionGetNumOutgoing(void);
...
extern SESSION* sessionFindAddressEstablished( UINT32 lIPAddress, UINT32 lHostIPAddr, INT32 nDirection );
