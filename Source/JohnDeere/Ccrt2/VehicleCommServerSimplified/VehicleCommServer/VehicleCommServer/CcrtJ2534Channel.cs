...
namespace VehicleCommServer
{
    ...
    {
        /// <summary>
        /// Default Constructor for CcrtJ2534Channel
        /// </summary>
        ...
        /// <summary>
        /// Default Constructor for CcrtJ2534ChannelSettings
        /// Class is container for settings specific to each j2534 channel
        /// </summary>
        ...
        /// <summary>
        /// Get String representation of Connect flag
        /// </summary>
        ...
        /// <summary>
        /// Set Connect flag based on string representation
        /// </summary>
        /// <param name="flag">string representation of connect flag</param>
        ...
        /// <summary>
        /// Get string representation of Baud Rate
        /// </summary>
        ...
        /// <summary>
        /// Set baud rate based on string representation fo baud rate
        /// </summary>
        /// <param name="baud">string representation of Baud Rate</param>
        ...
        /// <summary>
        /// Get Protocol ID based on string representation fo Protocol ID
        /// </summary>
        /// <returns>string representation fo Protocol ID</returns>
        public string GetProtocolID()
        {
            return ConvertFromProtocolID(ProtoID);
        }
        /// <summary>
        /// Set Protocol ID based on string representation fo Protocol ID
        /// </summary>
        /// <param name="protocol">string representation fo Protocol ID</param>
