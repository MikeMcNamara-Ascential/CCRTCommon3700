...
//===========================================================================
#include "IsuzuEngineControlModule.h"

//-------------------------------------------------------------------------------------------------
template<class ProtocolFilterType>
IsuzuEngineControlModule<ProtocolFilterType>::IsuzuEngineControlModule() :
...
//-------------------------------------------------------------------------------------------------
template <class ProtocolFilterType> 
bool IsuzuEngineControlModule<ProtocolFilterType>::InitializeHook(const XmlNode *configNode)
{   // Call the base class to begin the initialization
    ...
    Log(LOG_DEV_DATA, "IsuzuEngineControlModule::InitializeHook: Getting Dtc Info from Config");
    UINT8 byte = 0x00;
    try
    {
...
//-------------------------------------------------------------------------------------------------
template <class ProtocolFilterType> 
BEP_STATUS_TYPE IsuzuEngineControlModule<ProtocolFilterType>::ReadFaults(FaultStatusVector_t &faultCodes)
{
...
//-----------------------------------------------------------------------------
template<class ProtocolFilterType>
inline const UINT8& IsuzuEngineControlModule<ProtocolFilterType>::DtcCountIndex(const UINT8 *byte /*= NULL*/)
{
...
//-----------------------------------------------------------------------------
template<class ProtocolFilterType>
inline const UINT8& IsuzuEngineControlModule<ProtocolFilterType>::FirstDtcByteIndex(const UINT8 *byte /*= NULL*/)
{
...
//-----------------------------------------------------------------------------
template<class ProtocolFilterType>
inline const UINT8& IsuzuEngineControlModule<ProtocolFilterType>::BytesPerDtc(const UINT8 *byte /*= NULL*/)
{
