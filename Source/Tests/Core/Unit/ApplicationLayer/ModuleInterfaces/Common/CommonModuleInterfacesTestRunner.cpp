//******************************************************************************
// Description:
//   This is the TestRunner for the Common Module Interface tests.
//
//==============================================================================
...
//
// LOG:
//     $Log: /Ccrt/Source/Tests/Core/Unit/ApplicationLayer/ModuleInterfaces/Common/CommonModuleInterfacesTestRunner.cpp $
// 
...
int main( int argc, char* argv[])
{
    ...
    runner.addTest( new CommonModuleInterfacesTestSuite() );
