...
namespace MaintenanceReminder
{
    public partial class LocalizationForm : Form
    {
        ...
        /// <summary>
        /// Display the localization form so the user can select the display language.
        /// </summary>
        /// <param name="culture">Current culture in use.</param>
        /// <param name="resMgr">Resource manager for handling the languages.</param>
        public LocalizationForm(CultureInfo culture, ResourceManager resMgr)
        {
            ...
            if (MaintenanceReminder.Properties.Settings.Default.CurrentLanguage == "en-US")
            {
                m_englishRadioButton.Checked = true;
                m_spanishRadioButton.Checked = false;
            }
            else
            {
                m_englishRadioButton.Checked = false;
                m_spanishRadioButton.Checked = true;
            }
        ...
        private void UpdateDisplayLanguage()
        {
            ...
            m_spanishRadioButton.Text = GetLocalizedString("SpanishOption");
        ...
        {   // Store the selected language option
            ...
            {
                MaintenanceReminder.Properties.Settings.Default.CurrentLanguage = "en-US";
            }
            else
            {
                MaintenanceReminder.Properties.Settings.Default.CurrentLanguage = "es-MX";
            }
            MaintenanceReminder.Properties.Settings.Default.Save();
            // Create new objects for correctly displaying the form
            DisplayCulture = new CultureInfo(MaintenanceReminder.Properties.Settings.Default.CurrentLanguage, true);
