...
#include "KoreaAbsModuleTemplate.cpp"
...
public:
     ...
     * If a fault reader object has not been created, a new fault reader will be created and initialized.  Faults 
     * will then be retrieved from the module.
     * <p>
     * <b>Functions Called:</b>
     *      <ul>
     *      <li> GenericDCXCANModule::Initialize() </li>
     *      <li> GenericDCXCANModule::ReadFaults() </li>
     *      </ul>
     * 
     * @param faultCodes Fault codes read from the module.
     * @return Status of reading faults from the module.
     * @see GenericDCXCANModule
     */
    virtual BEP_STATUS_TYPE ReadFaultsCAN(FaultVector_t &faultCodes);
...
private:
    ...
    /**
     * Object to use to read fgaults from CAN bus modules.
     */
    GenericCANModuleTool *m_faultReader;
