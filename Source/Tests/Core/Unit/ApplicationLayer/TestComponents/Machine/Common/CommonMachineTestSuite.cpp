...
//
// LOG:
//     $Log: /Ccrt/Source/Tests/Core/Unit/ApplicationLayer/TestComponents/Machine/Common/CommonMachineTestSuite.cpp $
// 
...
CommonMachineTestSuite::CommonMachineTestSuite()
{
    // Add the inidividual test fixtures in this directory
    addTest(CommonMachineTest::suite());
}
