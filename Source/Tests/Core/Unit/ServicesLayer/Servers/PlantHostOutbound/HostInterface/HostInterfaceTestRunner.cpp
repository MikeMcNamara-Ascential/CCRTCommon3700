...
//
// LOG:
//     $Log: /Ccrt/Source/Tests/Core/Unit/ServicesLayer/Servers/PlantHostOutbound/HostInterface/HostInterfaceTestRunner.cpp $
// 
...
{   // Create the test runner and add it
    ...
    runner.addTest(new HostInterfaceTestSuite());
