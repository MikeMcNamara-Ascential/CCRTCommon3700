//*************************************************************************
// FILE:
//    $Header: /Isuzu/ServicesLayer/Servers/VehicleDataBroker/IsuzuVehicleDataBrokerMain.cpp 1     12/21/03 6:29p Cward $
//
// FILE DESCRIPTION:
//  Main loop for a IsuzuVehicleDataBroker.  If no special functionality is needed by a server,
...
//
// LOG:
//    $Log: /Isuzu/ServicesLayer/Servers/VehicleDataBroker/IsuzuVehicleDataBrokerMain.cpp $
// 
...
//
//*************************************************************************
#include "IsuzuVehicleDataBroker.cpp"
...
/**
 * Main loop for the IsuzuVehicleDataBroker
 *
...
int main(int argc, char *argv[])
{
	...
	try
	{
		IsuzuVehicleDataBroker server;		// Server object
	...
	if(clp.IsDebugOn()) printf("IsuzuVehicleDataBroker(%d, %s): Terminating\n", BposGetMyTaskId(), clp.GetConfigFile().c_str());
	return(0);
}

#ifdef __USAGE

IsuzuVehicleDataBroker Version 1.0
%C [options]
