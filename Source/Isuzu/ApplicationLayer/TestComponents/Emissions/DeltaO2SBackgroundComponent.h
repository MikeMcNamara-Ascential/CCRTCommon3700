...
template <class ModuleType> 
class DeltaO2SBackgroundComponent : public BackgroundTestComponent
{
public:
    /**
     ...
     */
    DeltaO2SBackgroundComponent(IsuzuDeltaEmissionsTc<ModuleType> *testComponent);
    /**
     * Class destructor.
     */
    virtual ~DeltaO2SBackgroundComponent();
    /**
