...
// 
//*************************************************************************
#ifndef TevesMk60Module_h
#define TevesMk60Module_h
//-------------------------------------------------------------------------------------------------
#include "GenericABSModuleTemplate.cpp"
//-------------------------------------------------------------------------------------------------
template<class ProtocolFilterType>
class TevesMk60Module : public GenericABSModuleTemplate<ProtocolFilterType>
{
public:
    TevesMk60Module();
    virtual ~TevesMk60Module();

    /**
     * <p><b>Description:</b><br>
     * Return a string representing the name of the module interface.
     * <p>
     * @returns "Teves MK60" for this class
     */
